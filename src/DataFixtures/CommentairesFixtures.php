...
// src/DataFixtures/CommentairesFixtures.php
...
class CommentairesFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $commentaire1->setIcone('/assets/image/icone-palmier.png'); // Définir l'icône pour ce commentaire
        ...
        $commentaire2->setIcone('/assets/image/icone-camel.png'); // Définir l'icône pour ce commentaire
        ...
        $commentaire3->setIcone('/assets/image/icone-4x4.png'); // Définir l'icône pour ce commentaire
